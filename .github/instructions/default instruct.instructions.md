...
applyTo: '**'
---
keep produced code clean and consise. it must be readable and understandable by a human
do not introduce unneccecary complexity, keep code and logic to the simplest it needs to be.
be mindfull of code efficency, if it can be improved without adding too much complexity it should be optimised
