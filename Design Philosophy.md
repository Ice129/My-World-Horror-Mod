...
This mod aims to maintain a vanilla feel in all aspects. Everything done by the mod must theoretically be possible in unmodded Minecraft. This can become more of a loose guideline as the mod progresses, but all actions and features need to feel as natural and player-made as possible.
...
The entity starts off elusive and not directly seen. The player should be guessing and assuming there is another player in their world from environmental clues like pre-mined caves and human-placed blocks.

**Phase 2: Terrified Avoidance**  
At first, the entity is terrified of the player, hiding and avoiding them at all costs. If attacked, they flee and "log out." Aggression towards the entity increases the aggro meter, which drives mod progression.

**Phase 3: Cautious Curiosity**  
When the entity becomes more accustomed to the player, they grow more inquisitive—finding the player's house, exploring it, and taking items from chests. The entity still wants to avoid direct confrontation, but they're more brave, occasionally punching the player off ledges or watching them from a distance.

**Phase 4: Active Hostility**  
Eventually, the entity becomes more bold—leaving traps for the player, stalking them, and even communicating through signs saying they want the player gone.

**Important:** The entity will never play loud noises and run at the player unprompted, unless that is the main climax of the mod. After the final kill, the player may be put into hardcore mode and can no longer respawn in the world.
